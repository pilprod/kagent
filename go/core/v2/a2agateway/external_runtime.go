...
func (d *RuntimeDialer) dialExternalSlot(
	ctx context.Context,
	...
	opener := &singleUseActorIngressDialer{
		open: func(dialCtx context.Context) (net.Conn, error) {
			return openActorIngress(dialCtx, d.ingress, instance, revision)
		},
	}
...
func openActorIngress(
	...
	actorRef := &ateapipb.ObjectRef{
		...
		Name:     externalActorName(instance.GetId()),
	}
...
func externalActorName(instanceID string) string {
	return "ai-" + strings.ToLower(instanceID)
}
